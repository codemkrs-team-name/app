...
if (!defined('USER_IMAGE_DIRECTORY')) {
	define('USER_IMAGE_DIRECTORY', WWW_ROOT . 'img' . DS . 'users' . DS);
}
if (!defined('PROJECT_IMAGE_DIRECTORY')) {
	define('PROJECT_IMAGE_DIRECTORY', WWW_ROOT . 'img' . DS . 'projects' . DS);
}
...
$s = array('convert' => 'image/jpeg', 'zoomCrop' => array(100, 100));
$m = array('convert' => 'image/jpeg', 'fitCrop' => array(300, 300));
$l = array('convert' => 'image/jpeg', 'fit' => array(600, 440));

$huge = array('convert' => 'image/jpeg', 'fit' => array(870, 870));
$large = array('convert' => 'image/jpeg', 'fit' => array(750, 750));
$mediumLarge = array('convert' => 'image/jpeg', 'fit' => array(500, 500));
$medium = array('convert' => 'image/jpeg', 'fit' => array(250, 250));
$small = array('convert' => 'image/jpeg', 'zoomCrop' => array(120, 120));
$thumbnail = array('convert' => 'image/jpeg', 'zoomCrop' => array(80, 80));

Configure::write('Media.filter', array('default' => array(
	'audio' => compact('s', 'm'),
	'document' => compact('s', 'm'),
	'generic' => array(),
	'image' => compact('huge', 'large', 'medium', 'small', 'thumbnail'),
	'video' => compact('s', 'm')
)));
