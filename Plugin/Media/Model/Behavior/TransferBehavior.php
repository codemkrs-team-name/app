 ...
 */
	public function transfer($Model, $file) {
		...
		if (!empty($temporary['file']))
		{
			while(is_file($temporary['file']) == TRUE)
        	{
        	    chmod($temporary['file'], 0666);
