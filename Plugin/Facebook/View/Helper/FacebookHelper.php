...
*/
	...
	public function init($options = null, $reload = true) {
		...
		if ($appId = FacebookInfo::getConfig('appId')) {
			...
			{
				/*$options['perms'] = 'email,user_about_me,user_birthday,user_likes,user_photos,user_location,user_interests,user_relationships,user_relationship_details,user_religion_politics,friends_likes';*/
				$options['perms'] = 'email,user_about_me,user_birthday,user_likes,user_photos,user_location,user_interests,user_relationships,user_relationship_details,user_religion_politics,read_stream';
				
				//email,publish_stream,user_about_me,user_birthday,user_likes,user_photos
	...
	window.fbAsyncInit = function() {
		FB.init({
			appId      : '$appId', // App ID
			channelURL : '/Facebook/Vendor/channel.php', // Channel File
